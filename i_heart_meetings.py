...
def perform_i_heart_meetings_calculations ():
    ...
    time_cost_total, financial_cost_total, time_cost_total_weekly = _calculate_cost_totals(meetings)
...
def _calculate_cost_totals(meetings):
    ...
    return time_cost_total, financial_cost_total, time_cost_total_weekly
...
def _calculate_percentage_time_in_meetings(time_cost_total_weekly):
    percentage_time_in_meetings = round(time_cost_total_weekly * 100)
